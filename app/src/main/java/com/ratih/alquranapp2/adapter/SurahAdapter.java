package com.ratih.alquranapp2.adapter;
...
import com.ratih.alquranapp2.R;
import com.ratih.alquranapp2.activities.ListSurahActivity;
import com.ratih.alquranapp2.model.ModelSurah;
...
public class SurahAdapter extends RecyclerView.Adapter<SurahAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(com.ratih.alquranapp2.R.layout.list_item_surah, parent, false);
    ...
    public static interface OnSelectedData {
        @Nullable
        SurahAdapter SurahAdapter(@NotNull List<ModelSurah> modelSurah, @NotNull ListSurahActivity listSurahActivity);
    }
